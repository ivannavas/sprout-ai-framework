...
class VoyageEmbeddingModelTest {
    ...
    private VoyageEmbeddingModel modelReturning(String responseJson, AtomicReference<String> capturedBody) throws IOException {
    ...
    void embedsASingleText() throws Exception {
        ...
        VoyageEmbeddingModel model = modelReturning(
        ...
        assertEquals("voyage-test", sent.path("model").asText());
