...
/**
 * The hand-off entry agent. It greets the user and transfers the conversation to a specialist; the
 * {@code handoff_to_*} tools are wired in at runtime by the {@code AgentHandoff} team in
 * {@link OrchestrationExampleApplication}.
 */
@Agent(
